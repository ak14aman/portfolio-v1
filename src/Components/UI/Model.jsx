...
import portfolios from '../../Assets/Data/projectData'
        ...
        <div className="w-11/12 md:max-w-[600px] md:w-full absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform -translate-x-1/2 -translate-y-1/2 p-5">
            ...
            <div>
                ...
                <a href={portfolio.github}>
                    <button className='bg-primaryColor text-white py-2 px-4 my-4 rounded-[8px] font-[500] hover:bg-headingColor ease-in duration-300'>
                        GitHub Link
                    </button>
                </a>
                
                {
                    (portfolio.siteUrl == '#')?(<div></div>): (<a href={portfolio.siteUrl}>
                    <button className='bg-primaryColor text-white py-2 px-4 my-4 rounded-[8px] font-[500] hover:bg-headingColor ease-in duration-300'>
                        View Live
                    </button>
                </a>)
